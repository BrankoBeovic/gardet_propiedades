            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 text-ivory/40 hover:text-red-400 transition-colors font-jakarta text-sm border border-obsidian-50/20 hover:border-red-400/30 px-4 py-2"
                    >
